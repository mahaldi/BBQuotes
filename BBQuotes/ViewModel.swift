...
class ViewModel {
    ...
    private(set) var status: FetchStatus = .notStarted // private set artinya ga ada yang bisa set variable ini, dan hanya bisa get. hanya bisa di set dari class view model ini aja
